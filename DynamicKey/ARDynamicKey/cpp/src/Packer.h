...
friend ar::tools::Packer & operator<< (ar::tools::Packer& p, const name & x) \
{	\
    p << x.name1; \
    return p;\
}\
friend ar::tools::Unpacker & operator>> (ar::tools::Unpacker & p, name & x) \
{			\
  p >> x.name1; \
    return p;\
}
