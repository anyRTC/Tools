...
void DynamicKey4_test::test_PublicSharingKey(){
    ...
    std::string result = ar::tools::DynamicKey4::generatePublicSharingKey(AppID, AppCertificate, channelName, unixTs, randomInt, uid, expiredTs);
...
void DynamicKey4_test::test_RecordingKey(){
    ...
    uint32_t uid=2882341273u;
    auto  expiredTs=1446455471;
    std::string result = ar::tools::DynamicKey4::generateRecordingKey(AppID, AppCertificate, channelName, unixTs, randomInt, uid, expiredTs);
...
void DynamicKey4_test::test_MediaChannelKey4(){
    ...
    uint32_t uid=2882341273u;
    auto  expiredTs=1446455471;
    std::string result = ar::tools::DynamicKey4::generateMediaChannelKey(AppID, AppCertificate, channelName, unixTs, randomInt, uid, expiredTs);
